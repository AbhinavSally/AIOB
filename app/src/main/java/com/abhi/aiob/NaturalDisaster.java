...
public class NaturalDisaster extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(this,"ca-app-pub-8870323806538407/3303235825");
        mAdView = (AdView) findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);
        store= FirebaseStorage.getInstance().getReference("newz");
        t=findViewById(R.id.toolbar5);
        t.setTitle("Natural Disaster");
        ...
        t.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(NaturalDisaster.this,Opt.class);
                startActivity(i);
            }
        });
        e1=findViewById(R.id.nde1);
        e2=findViewById(R.id.nde2);
        e3=findViewById(R.id.nde3);
        e4=findViewById(R.id.nde4);
        e5=findViewById(R.id.nde5);
        b=findViewById(R.id.ndb);
        img=findViewById(R.id.ndimg);
        deta= FirebaseDatabase.getInstance().getReference("newz");
        d=findViewById(R.id.ndd);
        ...
        if (photo != null ) {
            ...
            task.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(NaturalDisaster.this, "Successfully uploaded", Toast.LENGTH_SHORT).show();
                        ...
                        ss=s1+" is under NATURAL DISASTER on "+s+" with "+s3+" died "+s4+" injured with financial loss of "+s2+" as "+s5;
                        String id = deta.push().getKey();
                        news khabar = new news(id, ss, sti);
                        deta.child(id).setValue(khabar);
                        Intent i = new Intent(NaturalDisaster.this, Result.class);
                        startActivity(i);
                        finish();
                    }
                }
