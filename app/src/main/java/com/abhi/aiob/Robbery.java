    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(Robbery.this,Opt.class);
                startActivity(i);
            }
        });
        e1=findViewById(R.id.robe1);

        store = FirebaseStorage.getInstance().getReference();
        e2=findViewById(R.id.robe2);
        e3=findViewById(R.id.robe3);
        b=findViewById(R.id.robb);
        d=findViewById(R.id.robd);
        d.setVisibility(View.GONE);
        img=findViewById(R.id.robimg);
